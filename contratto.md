...
Analizzati il Documento di Visione e lo Studio di Fattibilità, la nostra proposta di contratto è la seguente:
- Realizzazione del progetto tramite  Rational Unified Process  (RUP)
- Analisi, progettazione e sviluppo del portale, del relativo database e del sistema API
- Garanzia di un'interfaccia semplice e usabile per gli utenti
- Garanzia di un'interfaccia completa e personalizzabile per i bibliotecari
- Sviluppo di documentazione semplice e accessibile per fornire un facile onboarding per i bibliotecari
- Installazione e configurazione del sistema nel suo ambiente di destinazione
- Rilascio della versione definitiva del software entro due anni dall'inizio
- Rilascio in alpha e beta per testare i vari sistemi e le integrazioni prima del rilascio ufficiale
...
Inoltre:
- L'utilizzo del portale sarà duraturo nel tempo e potrà essere ampliato o esteso in futuro con nuove funzionalità, sia dalla nostra azienda che da eventuali aziende terze.
...
- La documentazione fornita sarà da interpretare come prima fonte di autorevolezza in caso di rilasci futuri e perciò dovrà essere sempre mantenuta aggiornata.
